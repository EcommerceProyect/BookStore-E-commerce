...
function Card ({ id, imagen, titulo, autor, genero, sinopsis, editorial, ISBN }) {
  return (
...
<div class="relative w-full max-w-sm bg-white  border border-gray-200 rounded-lg shadow dark:border-gray-700">
    ...
    <div class="px-5 pb-5">
        ...
        <a href="#">
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">{titulo}</h5>
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">{genero}</h5>
            <h5 class="text-left text-xl font-semibold tracking-tight text-gray-900 dark:text-black">{autor}</h5>
        </a>
