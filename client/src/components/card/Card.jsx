      ...
      <div class="px-5 pb-5">
        ...
        <div class="flex items-center justify-between">
          ...
          {ISBN.stock === 0 || ISBN.stock < 0 ? (
            <button
              disabled
              className="text-gray-500 bg-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-300 dark:hover:bg-gray-400 dark:focus:ring-gray-800"
            >
              Stock agotado
            </button>
          ) : (
