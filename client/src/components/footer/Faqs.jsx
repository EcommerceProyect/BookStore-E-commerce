function Faqs() {
  return (
    <div class="container my-10 mx-auto md:px-6">
      <section class="mb-32">
        <h2 class="mb-6 text-textDark text-3xl font-bold dark:text-textLight">Preguntas Frecuentes</h2>

        <p class="dark:text-textLight mb-12 text-textDark">
          ¿No encontraste respuesta a la pregunta que tenías?
          <a href="#!" class="text-accents pl-5">
            Contáctanos
          </a>
        </p>
        ...
        <div class="grid gap-4 md:grid-cols-2">
          <div class="mb-6 md:mb-0">
            <p class="dark:text-textLight mx-2 font-bold text-textDark">
              Tengo problemas con el pago ¿Cómo puedo resolverlo?
            </p>
            <p class="dark:text-gray-100/85 mb-12 mx-2 text-textDark">
            ...
            <p class="dark:text-textLight mx-2 font-bold">¿Cuánto tarda en llegar el pedido?</p>
            <p class="dark:text-gray-100/85 mb-12 mx-2 text-textDark">
          ...
          <div class="mb-6 md:mb-0">
            <p class="dark:text-textLight mx-2 font-bold">
              ¿Es obligatorio crear una cuenta para comprar?
            </p>
            <p class="dark:text-gray-100/85 mb-12 mx-2 text-textDark">
              Sí, es necesario que te crees una cuenta para realizar compras.
            ...
            <p class="dark:text-textLight mx-2 font-bold">¿Cómo creo una cuenta?</p>
            <p class="dark:text-gray-100/85 mb-12 mx-2 text-textDark">
            ...
            <p class="dark:text-textLight font-bold mx-2">
              ¿Tengo algún descuento si compro en cantidad?
            </p>
            <p class="dark:text-gray-100/85 mb-12 text-textDark mx-2">
