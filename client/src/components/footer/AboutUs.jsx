          ...
          <div className="w-full px-4 mb-10 lg:mb-0 ">
            <div>
              <div className="px-4 pl-4 mb-6 border-l-4 border-blue-500">
                <h1 className="mt-2 text-xl font-black text-gray-700 md:text-4xl dark:text-gray-300">
                  Sobre nosotros
                </h1>
              </div>
              ...
              <p className="px-4 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                Despertar pasión por la lectura a través de la publicación de
                libros que atiendan la diversidad de los gustos y necesidades de
                una sociedad plural Creemos que los libros, las historias que
                cuentan y las ideas que transmiten, tienen el poder de
                fortalecer el diálogo y la cohesión social, de cambiarnos y
                enriquecernos, y contribuyen decisivamente a crear un futuro
              ...
              <div className="w-full px-4 mb-10 lg:mb-0">
                <img
                  src="https://www.soynorteclub.com/content/bucket/1/2571h550.jpg"
                  alt=""
