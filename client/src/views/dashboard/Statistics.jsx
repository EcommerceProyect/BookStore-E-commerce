...
export default function Statistics() {
  ...
  console.log('Propiedades que se están pasando a SalesChart:', orders);
  return (
    <div className='flex'>
    <Dashboard/>
        <div className="max-w-7xl mx-auto  px-4 sm:px-6 lg:py-24 lg:px-8">
    <h2 className="mb-10 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Estadísticas</h2>
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-4 mt-4">
        <div className="bg-white overflow-hidden shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
                <dl>
                    <dt className="text-sm leading-5 font-medium text-gray-500 truncate">Total de libros</dt>
                    <dd className="mt-1 text-3xl leading-9 font-semibold text-primary">{totalProducts}</dd>
                </dl>
            </div>
        </div>
        <div className="bg-white overflow-hidden shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <dd className="mt-1 text-3xl leading-9 font-semibold text-primary">${totalSales}</dd>
                </dl>
            </div>
        </div>
        <div className="bg-white overflow-hidden shadow sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
                <dl>
                    ...
                    <dd className="mt-1 text-3xl leading-9 font-semibold text-primary">{users.length}</dd>
                </dl>
            </div>
        </div>
    </div>
    <h2 className="mb-10 pt-12 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Ventas por día</h2>
    <SalesChart orders={orders}/>
    <h2 className="mb-10 pt-12 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Usuarios registrados por día</h2>
